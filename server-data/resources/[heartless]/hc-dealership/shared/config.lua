...
Config.PublicLot = {
    ...
    vehicles = {
        ...
        { model = 'faggio', label = 'Faggio', price = 2500 },
        ...
        { model = 'seashark', label = 'Seashark', price = 15000 },
    },
}
...
Config.ExclusiveLot = {
    ...
    vehicles = {
        ...
        { model = 'ip_m1000rr_23', label = 'BMW S1000RR 2023', tebexPackageId = 'PKG_S1000RR', priceUsd = 20 },
